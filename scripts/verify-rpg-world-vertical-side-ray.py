#!/usr/bin/env python3
"""Replay and lock BUIN1 vertical second-ray interaction, facing and restoration."""
...
def main() -> int:
    ...
    try:
        ...
        if expected.get("schema_version") != 1 or \
                expected.get("kind") != \
                    "original_rpg_buin1_vertical_side_ray_sequence" or \
                ...
                expected.get("player_world_position") != [18, 170] or \
                ...
                expected.get("center_ray_cells") != \
                    [[18, 169], [18, 168], [18, 167], [18, 166]] or \
                expected.get("second_ray_first_cell") != [17, 169] or \
        ...
        print(
            "RPG BUIN1 vertical side ray: vertical second Confirm ray, entity turn during "
            "dialogue and post-event facing restoration match the untouched "
            "original in five complete RGB pages")
        return 0
    except (OSError, ValueError, KeyError, IndexError, TypeError,
            json.JSONDecodeError, subprocess.SubprocessError) as error:
        parser.exit(1, f"RPG BUIN1 vertical side ray: FAIL: {error}\n")
