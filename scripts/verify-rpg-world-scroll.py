...
ROUTES = {
    ...
    "original_rpg_area1_west_scroll_sequence": {
        "direction": "LEFT",
        "initial_world": [130, 13],
        "final_world": [126, 13],
        "initial_viewport": [110, 1],
        "final_viewport": [106, 1],
        "kinds": ("initial_area1_west_scroll_page",
                  "second_west_scroll_page"),
        "rewrite_frames": (0, 2),
    ...
    "original_rpg_area1_north_scroll_sequence": {
        "direction": "UP",
        "initial_world": [126, 17],
        "final_world": [126, 13],
        "initial_viewport": [106, 5],
        "final_viewport": [106, 1],
        "kinds": ("initial_area1_north_scroll_page",
                  "first_north_scroll_page"),
        "rewrite_frames": (0, 1),
        "review_frames": (299, 542),
        "matched_count": 2,
        "polls": 4,
    ...
    "original_rpg_area1_screen_west_sequence": {
        "direction": "LEFT",
        "initial_world": [161, 12],
        "final_world": [160, 12],
        "initial_viewport": [140, 0],
        "final_viewport": [140, 0],
        "initial_screen": [40, 80],
        "final_screen": [38, 80],
        "kinds": ("initial_area1_west_step_world_page",
                  "west_screen_step_page"),
        "rewrite_frames": (0, 1),
        "review_frames": (299, 542),
        "matched_count": 2,
        "polls": 1,
    ...
    "original_rpg_area1_screen_north_sequence": {
        "direction": "UP",
        "initial_world": [20, 168],
        "final_world": [20, 167],
        "initial_viewport": [0, 155],
        "final_viewport": [0, 155],
        "initial_screen": [38, 88],
        "final_screen": [38, 80],
        "kinds": ("initial_area1_north_step_world_page",
                  "north_screen_step_page"),
        "rewrite_frames": (0, 1),
        "review_frames": (299, 542),
        "matched_count": 2,
        "polls": 1,
