#!/usr/bin/env python3
"""Stage AREA1 for the original four-cell west viewport scroll."""
...
EXPECTED_SAVE_SHA256 = "b28843e62cfbeac8748fe7b06b8794c845a83a74c2fa05835cab980ab1cb8d28"
...
def main() -> int:
    ...
    try:
        ...
        print(f"RPG AREA1 west-scroll fixture: {actual}")
        return 0
    except (OSError, ValueError) as error:
        parser.exit(1, f"RPG AREA1 west-scroll fixture: FAIL: {error}\n")
