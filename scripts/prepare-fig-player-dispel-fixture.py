#!/usr/bin/env python3
"""Create the deterministic FIG selector-61h player-dispel fixture."""
...
def main() -> int:
    ...
    try:
        ...
        word(data, 0x49C, 0x1002)  # 390 selects effect-67h attack buff
        word(data, 0x49E, 20)
        word(data, 0x3F2, 1)
        ...
        parser.exit(1, f"FIG player-dispel fixture: FAIL: {error}\n")
