#!/usr/bin/env python3
"""Replay and lock BUIN1 vertical centre interaction, facing and restoration."""
...
def main() -> int:
    ...
    try:
        ...
        if expected.get("schema_version") != 1 or \
                expected.get("kind") != \
                    "original_rpg_buin1_vertical_interaction_sequence" or \
                ...
                expected.get("player_world_position") != [16, 170] or \
        ...
        print(
            "RPG BUIN1 vertical interaction: vertical centre Confirm ray, entity turn during "
            "dialogue and post-event facing restoration match the untouched "
            "original in five complete RGB pages")
        return 0
    except (OSError, ValueError, KeyError, IndexError, TypeError,
            json.JSONDecodeError, subprocess.SubprocessError) as error:
        parser.exit(1, f"RPG BUIN1 vertical interaction: FAIL: {error}\n")
