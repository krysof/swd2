...
def main() -> int:
    ...
    try:
        ...
        if expected.get("schema_version") != 1 or \
                expected.get("kind") != "original_fig_introduction_yn_prompt" or \
                expected.get("formation_directory_offset") != 0x0B2 or \
        ...
        subprocess.run([
            ...
            str(args.reference.with_name("replay-fig-introduction-yn.txt")),
        ...
        print(
            "FIG YN introduction: bare enemy page, first glyph, all four animated "
            "cursor frames, both prompt selections, and eight exact original "
            "RGB pages")
        return 0
    except (OSError, ValueError, KeyError, IndexError, TypeError,
            json.JSONDecodeError, subprocess.SubprocessError) as error:
        parser.exit(1, f"FIG YN introduction: FAIL: {error}\n")
