#!/usr/bin/env python3
"""Replay and lock BUIN1 fourth-probe explicit interaction."""
...
def main() -> int:
    ...
    try:
        ...
        if expected.get("schema_version") != 1 or \
                expected.get("kind") != \
                    "original_rpg_buin1_fourth_probe_sequence" or \
                ...
                expected.get("player_world_position") != [11, 169] or \
                ...
                expected.get("entity_faced_direction") != 6 or \
                ...
                expected.get("forward_probe_cells") != \
                    [[12, 169], [13, 169], [14, 169], [15, 169]] or \
                expected.get("hit_probe_index") != 4 or \
        ...
        print(
            "RPG BUIN1 fourth probe: four-cell Confirm ray, dialogue and "
            "post-event facing restoration match the untouched "
            "original in five complete RGB pages")
        return 0
    except (OSError, ValueError, KeyError, IndexError, TypeError,
            json.JSONDecodeError, subprocess.SubprocessError) as error:
        parser.exit(1, f"RPG BUIN1 fourth probe: FAIL: {error}\n")
