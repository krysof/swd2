#!/usr/bin/env python3
"""Stage BUIN1's released explicit-interaction entity in isolation."""
...
EXPECTED_SAVE_SHA256 = \
    "4bff1518ebfc674d89a318be28275ad47594b9623e2f9c1865940e7267859dbf"
...
def main() -> int:
    ...
    try:
        ...
        # (18,169), face west and issue Confirm: the first 523d ray must find
        # the entity without any collision walk or automatic-event flag.
        for offset, value in (
                (0x408, 96), (0x40d, 55808), (0x40f, 8), (0x424, 268),
                (0x012, 34), (0x02a, 96), (0x0a2, 6),
                (0x41b, 0), (0x41d, 155)):
        ...
        print(f"RPG BUIN1 interaction fixture: SAVE {actual_save}, MAPZ {actual_mapz}")
        return 0
    except (OSError, ValueError) as error:
        parser.exit(1, f"RPG BUIN1 interaction fixture: FAIL: {error}\n")
