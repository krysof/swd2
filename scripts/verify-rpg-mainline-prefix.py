...
def main() -> int:
    ...
    try:
        ...
        expected_values = {
            ...
            ("video", "fnv1a64"): "82db4f6bd7f783df",
        ...
        aggregate_sequences = {
            ...
            "frame_fnv1a64": (36313,
                "1c20a87b1be7cea5ed2006682585d9d6de271191c2693732d384d790348f03d3"),
            "timeline": (128719,
                "d9997b899dc2ac2514ddf0e8da13beba9af6ff64ded98dfa383adbad88b04933"),
            "transitions": (150,
