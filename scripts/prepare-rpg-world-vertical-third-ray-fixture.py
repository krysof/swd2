#!/usr/bin/env python3
"""Stage BUIN1's released entity for the vertical third interaction ray."""
...
EXPECTED_SAVE_SHA256 = \
    "0d7eb28540136b713646289307b9f720e906fa9e1a39db9aaba0a540cfa31415"
...
def main() -> int:
    ...
    try:
        ...
        # (14,170), face north and issue Confirm.  The centre ray at x=14
        # and second/left ray at x=13 are empty; the third/right ray first
        # probe (15,169) finds the actor.
        for offset, value in (
                (0x408, 96), (0x40d, 55808), (0x40f, 8), (0x424, 268),
                (0x012, 26), (0x02a, 104), (0x0a2, 3),
                (0x41b, 0), (0x41d, 155)):
        ...
        print(f"RPG BUIN1 vertical third-ray fixture: SAVE {actual_save}, MAPZ {actual_mapz}")
        return 0
    except (OSError, ValueError) as error:
        parser.exit(1, f"RPG BUIN1 vertical third-ray fixture: FAIL: {error}\n")
