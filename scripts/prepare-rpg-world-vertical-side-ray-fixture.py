#!/usr/bin/env python3
"""Stage BUIN1's released entity for the vertical second interaction ray."""
...
EXPECTED_SAVE_SHA256 = \
    "3366d3faff55319e1df743516ebb659f8829b96dc94927678dafcd1c43c65ac9"
...
def main() -> int:
    ...
    try:
        ...
        # (18,170), face north and issue Confirm.  The centre ray at x=18
        # is empty; the second/left ray first probe (17,169) finds the actor.
        for offset, value in (
                (0x408, 96), (0x40d, 55808), (0x40f, 8), (0x424, 268),
                (0x012, 34), (0x02a, 104), (0x0a2, 3),
                (0x41b, 0), (0x41d, 155)):
        ...
        print(f"RPG BUIN1 vertical side-ray fixture: SAVE {actual_save}, MAPZ {actual_mapz}")
        return 0
    except (OSError, ValueError) as error:
        parser.exit(1, f"RPG BUIN1 vertical side-ray fixture: FAIL: {error}\n")
