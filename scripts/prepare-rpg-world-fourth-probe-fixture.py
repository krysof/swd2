#!/usr/bin/env python3
"""Stage BUIN1's released explicit-interaction fourth-probe entity in isolation."""
...
EXPECTED_SAVE_SHA256 = \
    "b90a2c04ea11e0330b62231a724a67972570cb903b437fe5889af3c5c18961a2"
...
def main() -> int:
    ...
    try:
        ...
        # (11,169), face east and issue Confirm: probes x=12,13,14 are empty
        # and the fourth/maximum probe x=15 must find the actor.
        for offset, value in (
                (0x408, 96), (0x40d, 55808), (0x40f, 8), (0x424, 268),
                (0x012, 20), (0x02a, 96), (0x0a2, 9),
                (0x41b, 0), (0x41d, 155)):
        ...
        print(f"RPG BUIN1 fourth-probe fixture: SAVE {actual_save}, MAPZ {actual_mapz}")
        return 0
    except (OSError, ValueError) as error:
        parser.exit(1, f"RPG BUIN1 fourth-probe fixture: FAIL: {error}\n")
