#!/usr/bin/env python3
"""Create the deterministic captured-ally departure fixture."""
...
EXPECTED = "d8aa410ccd141ef88f48db4c4c57539f1f361ba45003ac859e58d73ee5c0a962"
...
def main() -> int:
    ...
    try:
        ...
        word(data, 0x49C, 0x108C)        # summon, then deterministic random-seven departure
        word(data, 0x382, 420)           # captured item “童女”
        word(data, actor + 0x0C, 1)      # player physical attack stays harmless
        ...
        if actual != EXPECTED:
            raise ValueError(f"FIG captured-ally departure fixture differs: {actual}")
        (args.output / "SAVE.DA1").write_bytes(data)
        print(f"FIG captured-ally departure fixture: {actual}")
        return 0
    except (OSError, ValueError) as error:
        parser.exit(1, f"FIG captured-ally departure fixture: FAIL: {error}\n")
