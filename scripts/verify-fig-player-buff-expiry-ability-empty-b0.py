#!/usr/bin/env python3
"""Lock FIG same-turn attack-buff expiry after empty B0 dismissal."""
...
def main() -> int:
    ...
    try:
        ...
        if expected.get("schema_version") != 1 or \
                expected.get("kind") != \
                    "original_fig_player_buff_expiry_after_empty_b0_medium_dismissal" or \
                ...
                (expected.get("dismiss_ability_id"),
                 expected.get("dismiss_effect_code")) != (83, 0x3f) or \
        ...
        if not isinstance(limitation, str) or \
                ...
                not all(token in limitation for token in (
                    "0a97", "4338", "4377", "4894", "482e", "0c41", "0da7",
                    "0d98")):
