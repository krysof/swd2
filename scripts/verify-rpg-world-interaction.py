#!/usr/bin/env python3
"""Replay and lock BUIN1 explicit interaction, facing and restoration."""
...
def main() -> int:
    ...
    try:
        ...
        if expected.get("schema_version") != 1 or \
                expected.get("kind") != \
                    "original_rpg_buin1_explicit_interaction_sequence" or \
                ...
                expected.get("player_world_position") != [18, 169] or \
