#!/usr/bin/env python3
"""Stage BUIN1's released explicit-interaction probe-limit entity in isolation."""
...
EXPECTED_SAVE_SHA256 = \
    "25e95285b2d09f5c14c226ea9889e75af13902377693a81122227b30289169db"
...
def main() -> int:
    ...
    try:
        ...
        # (10,169), face east and issue Confirm: probes x=11..14 are empty.
        # The actor at x=15 would be a fifth probe and must not be found.
        for offset, value in (
                (0x408, 96), (0x40d, 55808), (0x40f, 8), (0x424, 268),
                (0x012, 4), (0x02a, 96), (0x0a2, 9),
                (0x41b, 0), (0x41d, 155)):
        ...
        print(f"RPG BUIN1 probe-limit fixture: SAVE {actual_save}, MAPZ {actual_mapz}")
        return 0
    except (OSError, ValueError) as error:
        parser.exit(1, f"RPG BUIN1 probe-limit fixture: FAIL: {error}\n")
