#!/usr/bin/env python3
"""Replay and prove FIG's two-page introduction without a prompt."""
...
def main() -> int:
    ...
    try:
        ...
        rewrite_frames = [0, 1] + list(range(3, 10))
        if expected.get("schema_version") != 1 or \
                expected.get("kind") != "original_fig_two_page_introduction" or \
                expected.get("formation_directory_offset") != 0x042 or \
        ...
        subprocess.run([
            ...
            str(args.reference.with_name("replay-fig-introduction-two-page.txt")),
        ...
        print(
            "FIG two-page introduction: both text pages, all four final cursor "
            "phases, and nine exact original RGB pages")
        return 0
    except (OSError, ValueError, KeyError, IndexError, TypeError,
            json.JSONDecodeError, subprocess.SubprocessError) as error:
        parser.exit(1, f"FIG two-page introduction: FAIL: {error}\n")
