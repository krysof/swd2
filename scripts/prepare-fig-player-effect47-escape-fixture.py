...
EXPECTED_FIXED_SAVE = "0533ff61fc5af62a4f9680788dd026e425f3788c9ee519a25cb3517fefc0e6af"
EXPECTED_FIXED_ITEM_SAVE = "c6b8d260a184f92dc52ea6f74f715c14169a2a583de1e71b3f5b4633184125e5"
EXPECTED_ORC = "e9dd243bc22afcd93f5474de6f481651fc7e45ead2aaeba8e06f78e9b9befec5"
EXPECTED_FIXED_ORC = "454912f918eaebe0e80cfdddb76a8f48daed9aab7e4d475acdb62e458518ccae"
...
def main() -> int:
    ...
    mode.add_argument(
        ...
        help="stage learned ability 7 in fixed formation 392")
    mode.add_argument(
        "--fixed-item", action="store_true",
        help="stage type-10 item 237 in fixed formation 392")
    ...
    try:
        ...
        word(save, 0x10, 1)
        fixed = args.fixed or args.fixed_item
        use_item = args.item or args.fixed_item
        word(save, 0x4A0, 392 if fixed else 0)
        ...
        if args.fixed_item:
            expected_save = EXPECTED_FIXED_ITEM_SAVE
        elif args.fixed:
            expected_save = EXPECTED_FIXED_SAVE
        else:
            expected_save = EXPECTED_ITEM_SAVE if args.item else EXPECTED_SAVE
        expected_orc = EXPECTED_FIXED_ORC if fixed else EXPECTED_ORC
